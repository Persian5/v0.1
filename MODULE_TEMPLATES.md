# 📚 MODULE 1 & MODULE 2 COMPLETE TEMPLATES
...
**Review Vocabulary:** `["salam", "chetori"]`
...
19. **audio-sequence** - ["esme", "man"] → "My name" (3 XP)
...
**Pattern C: Review + New Content (Lesson 3, 4)**
- Welcome intro
